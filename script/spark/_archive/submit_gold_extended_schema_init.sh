#!/usr/bin/env bash
# Submit GoldExtendedSchemaInitJob manually from the host via Airflow container.

set -euo pipefail

SPARK_SUBMIT_CONTAINER="${SPARK_SUBMIT_CONTAINER:-airflow}"
RESET_GOLD_EXTENDED_SCHEMA="${RESET_GOLD_EXTENDED_SCHEMA:-false}"
...
echo "==> Submitting GoldExtendedSchemaInitJob ..."
echo "==> RESET_GOLD_EXTENDED_SCHEMA=${RESET_GOLD_EXTENDED_SCHEMA}"
