"""Result validator (ported verbatim from code/api/result_validator.py).

Pure Python. Produces warnings, a confidence label, and validation notes from
the result rows and the parsed intent. Never raises.
"""
...
def _uses_fact_sales(generated_sql: str, table_candidates: list[str], used_tables: list[str]) -> bool:
